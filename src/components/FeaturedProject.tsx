                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div className="flex-1 space-y-3">
                            <h4 className="text-lg font-semibold text-foreground">{t("projects.items.xenora-rush.title")}</h4>
                            <p className="text-lg text-muted-foreground leading-relaxed">{t("projects.items.xenora-rush.summary")}</p>
                        </div>
